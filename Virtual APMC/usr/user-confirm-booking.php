  ...
  if(isset($_POST['book_product']))
    {
            ...
            $query="insert into apmc_order(s_id,u_id,p_id,f_name,l_name,o_phone,o_add,p_name,p_category,p_seller,p_price,p_qty,o_status,o_date) values (?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
            $stmt = $mysqli->prepare($query);
            $rc=$stmt->bind_param('iiisssssssssss',$s_id,$u_id , $p_id,$u_fname,$u_lname,$u_phone,$u_addr, $p_name,$p_category ,$p_owner,$p_price,$p_quantity,$o_book_status,$o_bookdate );
            $stmt->execute();
                if($stmt)
                {
    ...
    <div id="content-wrapper">
      ...
      <?php if(isset($succ)) {?>
        ...
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item ">Book Product</li>
        ...
        ?>
          ...
          <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" value="<?php echo $row->u_phone;?>" id="exampleInputEmail1"  readonly name="u_phone" required>
            </div>

            <div class="form-group">
                <label for="exampleInputEmail1">Address</label>
                <input type="text" class="form-control" value="<?php echo $row->u_addr;?>" id="exampleInputEmail1" readonly name="u_addr" required>
            </div>      
            <?php
            $aid=$_GET['id'];
            ...
            <div class="form-group">
              <label for="exampleFormControlSelect1">Seller id:</label>
              <input type="text" class="form-control" value="<?php echo $row->s_id;?>" id="exampleInputEmail1" readonly name="s_id">
            </div>


            <div class="form-group">
                <label for="exampleInputEmail1">Booking Date</label>
                <input type="text" class="form-control" id="exampleInputEmail1" value="<?php echo date("m/d/Y");?>" readonly name="o_bookdate" required>
            </div>
       
            <div class="form-group">
              <label for="exampleFormControlSelect1">Booking Status</label>
              <select class="form-control" name="o_book_status" id="exampleFormControlSelect1" readonly required>

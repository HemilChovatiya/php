      ...
      <div class="container-fluid">
        ...
        ?>
            ...
            <div class="card col-md-8" >
                <div class="card-body">
                    <h5 class="card-title text-capitalize"><?php echo $row->u_fname;?> <?php echo $row->u_lname;?></h5>
                </div>
                <ul class="list-group list-group-flush">
                    <li class="list-group-item text-capitalize"><b>Address:</b> <?php echo $row->u_addr;?></li>

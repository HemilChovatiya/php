  ...
  if(isset($_POST['add_product']))
    {
            ...
            $query="insert into product (pname, category, price, address, p_owner, p_status,description,p_quantity, p_img_loc,phone) values(?,?,?,?,?,?,?,?,?,?)";
            if(isset($stmt)){
              $stmt->close();}
            $stmt = $mysqli->prepare($query);
            //echo  '1.'.$p_name.'2.'.$p_category.'3.'.$p_price.'1.'.$address.'1.'.$p_owner.'1.'.$p_status.'1.'.$p_des.'1.'.$p_quantity.'       vvppp_>>>>>'.$p_pic_loc;
            $rc=$stmt->bind_param('ssssssssss', $p_name, $p_category,$p_price,$address,$p_owner,$p_status,$p_des,$p_quantity,$p_pic_loc,$phone);
            $stmt->execute();
                if($stmt)
                {
                    $succ = "Product Added";
          ...
          <form method ="POST" enctype="multipart/form-data"> 
            <div class="form-group">
	          ...
	          <div class="form-group">
                ...
                <input type="text" required class="form-control" id="exampleInputEmail1" name="p_des" placeholder='Product Short Description in 100 characters'>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
              ...
              <select class="form-control" name="p_owner" id="exampleFormControlSelect1">
                ...
                $ret="SELECT * FROM user"; //sql code to get to User randomly
                if(isset($stmt)){
                $stmt->close();}

  ...
  if(isset($_POST['delete_booking']))
    {
            ...
            $query="delete from apmc_order where o_id=?";
            $stmt = $mysqli->prepare($query);
            $rc=$stmt->bind_param('i',  $o_id);
            $stmt->execute();
                if($stmt)
                {
        ...
        ?>
          ...
          <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input type="date" class="form-control" id="exampleInputEmail1" value="<?php echo $row->o_date;?>"  name="o_bookdate" readonly required>
            </div>

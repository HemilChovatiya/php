<?php
  ...
  if(isset($_POST['signup'])){
    ...
    if($res==1){
      ...
      $msg = "Your Account has been Sign Up Successfully";
      redirect('index.php');
    }
    else{
...
<head>
  ...
  <title>Chemx SignIn/SignUp</title>
<style>
...
body {
  ...
  background-image: url(/project/icons/login.svg);
...
.overlay {
  background: transparent;
  background: linear-gradient(to right, #ff4b2b, red) no repeat 0 0 / cover;
  color: black;
  position: absolute;
  left: -100%;
  height: 100%;
...
<body>
  <div class="container" id="container">
    <div class="form-container sign-up-container">
      <form method="post" action="/project/login/index.php">
        <h1>Create Account</h1>
        <span>Create an account for free </span>
        <input type="text" name="name" placeholder="Name" />
        <input type="email" name="username"placeholder="Email" />
        <input type="password" name="password" placeholder="Password" />
        <button type="submit" onclick="alert('<?php $msg ?>')" name="signup">Sign Up</button>
    ...
    <div class="form-container sign-in-container">
      <form method="post" >
        ...
        <button type="submit" onclick="alert('<?php $msg ?>')" name="signin">Sign In</button>
